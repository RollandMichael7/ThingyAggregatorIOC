...
/* Generated from ../O.Common/thingy.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_syncInitialize, pvar_func_thingyRegister,
    pvar_func_tsInitialize, pvar_func_register_func_register_pv,
    pvar_func_register_func_register_sensor,
    pvar_func_register_func_toggle_led;
...
int thingy_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/mrolland/Documents/ioc/ThingyAggregatorIOC";
    ...
    pvar_func_thingyRegister();
    pvar_func_tsInitialize();
    pvar_func_register_func_register_pv();
    pvar_func_register_func_register_sensor();
    pvar_func_register_func_toggle_led();
...
/* thingy_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"thingy_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    thingy_registerRecordDeviceDriver(*iocshPpdbbase);
}
